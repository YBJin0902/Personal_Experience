...
#
# ZCU104_DPU_proj.tcl: Tcl script for re-creating project 'ZCU104_DPU_proj'
#
# Generated by Vivado on Wed Aug 05 21:26:07 +0800 2026
...
#
# 1. This project restoration tcl script (ZCU104_DPU_proj.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "F:/LCM/Xilinx/project/ZCU104_DPU_proj/ZCU104_DPU_proj.srcs/sources_1/bd/main_design/main_design.bd"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/ZCU104_DPU_proj.srcs/sources_1/bd/main_design/main_design.bd"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../IP/DPUCZDX8G_ip_repo_VAI_v3.0/DPUCZDX8G_v4_1_0"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "ZCU104_DPU_proj"
...
set script_file "ZCU104_DPU_proj.tcl"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../IP/DPUCZDX8G_ip_repo_VAI_v3.0/DPUCZDX8G_v4_1_0"]" $obj
...
if { [get_property IS_LOCKED [ get_files -norecurse main_design.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/ZCU104_DPU_proj.gen/sources_1/bd/main_design/hdl/main_design_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse main_design.bd] -top]
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/ZCU104_DPU_proj.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/ZCU104_DPU_proj.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/ZCU104_DPU_proj.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
