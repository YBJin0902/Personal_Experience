...
/* LoRa ----------------------------------------------------------------------------------------------------*/
//u8 LoRa_OK[]={"AT\r\n"};
u8 LoRa_AddressSet[]={"AT+ADDRESS=43237\r\n"};
u8 LoRa_NetworkIDSet[]={"AT+NETWORKID=5\r\n"};
u8 LoRa_ParameterSet[]={"AT+PARAMETER=10,7,1,7\r\n"};
u8 LoRa_SendSet[]={"AT+SEND=43228,4,A\r\n"};
////////////////////////////////////////////////////////////////

/*
u8 LoRa_Addressset[]={"AT+ADDRESS?\r\n"};
u8 LoRa_NetworkIDset[]={"AT+NETWORKID?\r\n"};
u8 LoRa_Parameterset[]={"AT+PARAMETER?\r\n"};
u8 LoRa_Sendset[]={"AT+SEND?\r\n"};
*/
...
/*
  while (1)
  {
    UxART_RxTest();
		...
		Usart_SendStr(HTCFG_UART_PORT,LoRa_SendSet);
		Delay(1);
  }
*/
