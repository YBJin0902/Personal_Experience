...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_UART_IPN                          USART1
	...
	#define COM2_TX_GPIOX                   				A
  #define COM2_TX_GPION                   				2
  #define COM2_RX_GPIOX                   				A
  #define COM2_RX_GPION                   				3
  #define COM2_IPN                         				USART0
	
	
	#define COM3_TX_GPIOX                   				B
  #define COM3_TX_GPION                   				2
  #define COM3_RX_GPIOX                   				B
  #define COM3_RX_GPION                   				3
  #define COM3_IPN                         				USART0
...
//#define COM2_TX_GPIO_ID                     STRCAT2(GPIO_P,         COM2_TX_GPIOX)
//#define COM2_RX_GPIO_ID                     STRCAT2(GPIO_P,         COM2_RX_GPIOX)
//#define COM2_TX_AFIO_PIN                    STRCAT2(AFIO_PIN_,      COM2_TX_GPION)
//#define COM2_RX_AFIO_PIN                    STRCAT2(AFIO_PIN_,      COM2_RX_GPION)
//#define COM2_PORT                           STRCAT2(HT_,             COM2_IPN)
//#define COM2_IRQn                           STRCAT2(COM2_IPN, _IRQn)
//#define COM2_IRQHandler                     STRCAT2(COM2_IPN, _IRQHandler)



//#define HTCFG_UART3_TX_GPIO_ID                     STRCAT2(GPIO_P,         COM3_TX_GPIOX)
//#define HTCFG_UART3_RX_GPIO_ID                     STRCAT2(GPIO_P,         COM3_RX_GPIOX)
//#define HTCFG_UART3_TX_AFIO_PIN                    STRCAT2(AFIO_PIN_,      COM3_TX_GPION)
//#define HTCFG_UART3_RX_AFIO_PIN                    STRCAT2(AFIO_PIN_,      COM3_RX_GPION)
//#define HTCFG_UART3_PORT                           STRCAT2(HT_,             COM3_IPN)
//#define HTCFG_UART3_IRQn                           STRCAT2(COM3_IPN, _IRQn)
//#define HTCFG_UART3_IRQHandler                     STRCAT2(COM3_IPN, _IRQHandler)
