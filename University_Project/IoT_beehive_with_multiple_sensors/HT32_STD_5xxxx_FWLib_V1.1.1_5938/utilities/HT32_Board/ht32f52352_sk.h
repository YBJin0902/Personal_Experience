...
#define COM2_CLK(CK)                (CK.Bit.USART0)
#define COM2_PORT                   (HT_USART0)
#define COM2_IRQn                   (USART0_IRQn)
#define COM2_IRQHandler             (USART0_IRQHandler)

#define COM2_TX_GPIO_ID             (GPIO_PA)
#define COM2_TX_AFIO_PIN            (AFIO_PIN_2)
#define COM2_TX_AFIO_MODE           (AFIO_FUN_USART_UART)

#define COM2_RX_GPIO_ID             (GPIO_PA)
#define COM2_RX_AFIO_PIN            (AFIO_PIN_3)
#define COM2_RX_AFIO_MODE           (AFIO_FUN_USART_UART)

#define COM3_NUM                     (1)

#define COM3_CLK(CK)                (CK.Bit.UART0)
#define COM3_PORT                   (HT_UART0)
#define COM3_IRQn                   (UART0_IRQn)
#define COM3_IRQHandler             (UART0_IRQHandler)

#define COM3_TX_GPIO_ID             (GPIO_PB)
#define COM3_TX_AFIO_PIN            (AFIO_PIN_2)
#define COM3_TX_AFIO_MODE           (AFIO_FUN_USART_UART)

#define COM3_RX_GPIO_ID             (GPIO_PB)
#define COM3_RX_AFIO_PIN            (AFIO_PIN_3)
#define COM3_RX_AFIO_MODE           (AFIO_FUN_USART_UART)
